function state = getInitState(p, sys_n, sys_p, V0)
...
[c_ss_n,t,c_nx] = lsim(sys_n,[I;I;I],t,s0.c_n0);     % Anode Particle
[c_ss_p,t,c_px] = lsim(sys_p,[I;I;I],t,s0.c_p0);     % Cathode Particle
...
dfca_n = electrolyteAct(cen_bar(2),s0.T0,p);
dfca_s = electrolyteAct(ces_bar(2),s0.T0,p);
dfca_p = electrolyteAct(cep_bar(2),s0.T0,p);
